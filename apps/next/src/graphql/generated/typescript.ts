...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    saveNewUserInformation(
      variables: SaveNewUserInformationMutationVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<SaveNewUserInformationMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<SaveNewUserInformationMutation>(
    ...
    getAccountProfile(
      variables?: GetAccountProfileQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<GetAccountProfileQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetAccountProfileQuery>(GetAccountProfileDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'getAccountProfile',
    ...
    getHealthStatus(
      variables?: GetHealthStatusQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<GetHealthStatusQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetHealthStatusQuery>(GetHealthStatusDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'getHealthStatus',
