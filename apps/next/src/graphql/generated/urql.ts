...
export function useSaveNewUserInformationMutation() {
  return Urql.useMutation<SaveNewUserInformationMutation, SaveNewUserInformationMutationVariables>(
    SaveNewUserInformationDocument
  )
}
...
export function useGetAccountProfileQuery(
  options?: Omit<Urql.UseQueryArgs<GetAccountProfileQueryVariables>, 'query'>
) {
  return Urql.useQuery<GetAccountProfileQuery, GetAccountProfileQueryVariables>({
    query: GetAccountProfileDocument,
    ...options,
  })
}
...
export function useGetHealthStatusQuery(
  options?: Omit<Urql.UseQueryArgs<GetHealthStatusQueryVariables>, 'query'>
) {
  return Urql.useQuery<GetHealthStatusQuery, GetHealthStatusQueryVariables>({
    query: GetHealthStatusDocument,
    ...options,
  })
}
...
export function useTestQueryQuery(
  ...
  return Urql.useQuery<TestQueryQuery, TestQueryQueryVariables>({
